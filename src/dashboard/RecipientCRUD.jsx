        ...
        return (
            ...
            <div className="max-w-5xl mx-auto p-6">
                ...
                <div className='flex justify-end'>
                    <button className='bg-gray-300 px-3 py-3 rounded-md font-semibold hover:bg-gray-400 duration-200 cursor-pointer'
                ...
                <div className="overflow-x-auto">
                    ...
                    <thead className="bg-gray-50 sticky top-0 z-10">
                        ...
                        <th className="px-6 py-3  text-sm font-semibold text-gray-700 uppercase tracking-wider text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody className="bg-white divide-y divide-gray-200 text-gray-800 text-sm">
                        ...
                        >
                            ...
                            <button className='font-semibold text-white px-4 py-3 mt-1 mb-2 ml-4 bg-blue-400 rounded-md shadow-md hover:bg-blue-700 duration-400 cursor-pointer'
                            key={item.id}
                            onClick={()=>{
                                navigate(`/recipient-view/${item.id}`)
                            }}
                            >Edit</button>
                            <button 
                            onClick={(e)=> {
